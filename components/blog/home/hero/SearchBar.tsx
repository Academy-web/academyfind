...
export default function SearchBar() {
  ...
  return (
    ...
    >
      <div className="group relative flex items-center rounded-2xl border border-slate-200 bg-white px-5 py-3 shadow-lg shadow-slate-200/40 transition-all duration-300 hover:shadow-xl focus-within:border-amber-400 focus-within:ring-4 focus-within:ring-amber-100">
        {/* Search Icon */}
