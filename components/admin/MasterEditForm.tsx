...
export default function MasterEditForm({ 
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (data.secure_url) {
                setMainImageUrl(data.secure_url); // Update state to new Cloudinary URL
    ...
    async function handleFormSubmit(formData: FormData) {
        setIsLoading(true);
        formData.append("imageUrl", mainImageUrl); // Ensure the URL gets sent to DB
    ...
    return (
        <form action={handleFormSubmit} className="space-y-8">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                ...
                {/* ... existing code (Name, Slug fields) ... */}
