...
export default async function AdminCallbackDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-6">
      {/* 🚀 Back Button */}
      <Link href="/admin/instituteCallbacks" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
        ...
        <div className="mb-8">
          ...
          {callback.institute ? (
            <Link 
              href={`/admin/institutes/${callback.institute.id}`}
