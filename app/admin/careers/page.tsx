                        ...
                        {jobs.map((job: any) => (
                            <tr key={job.id} className="hover:bg-slate-50/50 transition">
                                ...
                                <td className="p-4 text-center">
                                    <Link href={`/admin/careers/${job.id}`} className="inline-flex items-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-700 px-4 py-2 rounded-xl font-bold transition">
                                ...
                                <td className="p-4 text-right">
                                    <div className="flex items-center justify-end gap-3">
                                        <Link href={`/careers/${job.slug}`} target="_blank" className="text-slate-400 hover:text-slate-900 transition" title="View Public Page">
                                            <Eye className="w-4 h-4" />
                                        </Link>
                                        <Link href={`/admin/careers/${job.id}/edit`} className="text-purple-600 hover:text-purple-800 font-bold text-xs uppercase tracking-wider">
                                            Edit Post
                                        </Link>
                                    </div>
                                </td>
