            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-4">
                ...
                <div className="border border-slate-200 bg-white rounded-3xl shadow-sm overflow-hidden flex flex-col">
                    <div className="p-5 border-b bg-slate-50 flex items-center justify-between">
                        ...
                        <Link href="/admin/claims" className="text-xs font-bold text-red-600 hover:underline">View All</Link>
                    </div>
                        ...
                        {recentClaims.length === 0 ? (
                            ...
                            recentClaims.map((claim: any) => (
                                <div key={claim.id} className="flex justify-between items-center p-3 rounded-xl border border-slate-100 hover:bg-slate-50 transition">
                                    ...
                                    <Link href="/admin/claims" className="shrink-0 bg-slate-900 text-white text-xs px-3 py-1.5 rounded-lg hover:bg-slate-800">
                                        Review
                                    </Link>
                                </div>
                            ))
                ...
                <div className="border border-slate-200 bg-white rounded-3xl shadow-sm overflow-hidden flex flex-col">
                    <div className="p-5 border-b bg-slate-50 flex items-center justify-between">
                        ...
                        <Link href="/admin/users" className="text-xs font-bold text-blue-600 hover:underline">Manage Users</Link>
                    </div>
                    <div className="p-5 flex-1 space-y-4">
